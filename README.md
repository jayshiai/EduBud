...
To try out the agent capabilites to interact with real time internet, you'll need to give the agent access to the internet by populating the `SERPAPI_API_KEY` in `.env.local`.
